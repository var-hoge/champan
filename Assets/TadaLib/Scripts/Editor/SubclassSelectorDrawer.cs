...
{
    [CustomPropertyDrawer(typeof(Attribute.SubclassSelectorAttribute))]
    public class SubclassSelectorDrawer : PropertyDrawer
    {
        ...
        {
            Attribute.SubclassSelectorAttribute utility = (Attribute.SubclassSelectorAttribute)attribute;
